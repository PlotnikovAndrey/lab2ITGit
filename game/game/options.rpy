...
define config.name = _("VSU_Zero_Care_Dilemma")
...
define build.name = "VSU_Zero_Care_Dilemma"
...
define config.save_directory = "test1-1604602818"
...
init python:
    ...
    config.window_icon = "images/logo/logo.png"
    config.windows_icon = "images/logo/logo.png"
    build.classify('**~', None)
